...
import { validarMesaOcupada } from "@/validations/validarMesaOcupada";
import { metodos_de_pago } from "@/data/metodos_de_pago";

const ModalNuevoPedido = () => {
  const { openModalNuevoPedido, setOpenModalNuevoPedido } =
  ...
  const { agregarNuevoPedido, crearOrdenBaseDatos } = useCarritoCompras();
  ...
  const handleClickPedir = async () => {
    const data = {
      ...
      metodo_de_pago: formDatos.metodo_de_pago, // Asegurarse de que el campo exista
    };
    ...
    if (validarMesaOcupada(ordenes, formDatos.mesa)) {
      toast.error("La mesa ya está ocupada por otro pedido.", {
        duration: 2000,
        position: "top-center",
        style: {
          background: "#FEE2E2",
    ...
    const nuevaOrden = {
      ...
      comentarios: "",
      metodo_de_pago: "efectivo", // Asegurarse de que el campo exista
    };
    setFormDatos(nuevaOrden);
    setOpenModalNuevoPedido(false);
  };
      ...
      {openModalNuevoPedido && (
        <div className="fixed inset-0 z-30 flex items-center bg-black/10 justify-center bg-opacity-90 overflow-auto">
          <motion.div
            ...
            onClick={() => setOpenModalNuevoPedido(false)}
          >
            <div
                ...
                <div className="bg-white p-6 text-zinc-800 mt-4">
                  <div className="w-full flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2 text-black">
                      ...
                      <span className="font-bold">{formDatos?.pedido}</span>
                    </div>
                  </div>
                                ...
                                >
                                  ...
                                  ${
                                    ...
                                    metodo.id === "tarjeta_credito"
                                      ...
                                      metodo.id === formDatos.metodo_de_pago
                                        ? "bg-green-600/50"
                                        : "bg-green-50"
                                    }`}
                                  >
