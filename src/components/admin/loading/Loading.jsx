...
const Loading = () => {
  return (
    <div className="bg-[#F7F7F7] dark:bg-slate-950 max-w-screen max-h-screen flex items-center justify-center fixed inset-0 z-20 h-svh w-screen">
      <div className="">
        <video
          src="/admin/Mainfud-2.mp4"
          width={900}
          height={900}
